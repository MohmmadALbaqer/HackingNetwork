...
print(colored_text + " I am not responsible for any behavior or misuse. Please observe the law ")

text = "تحذير :"
colored_text = colored(text, 'red')
print(colored_text + " أنا غير مسؤول عن أي تصرف أو سوء الاستخدام. الرجاء مراعاة القانون.")
